...
\item 
bool \mbox{\hyperlink{a00401_af811d21e4c49275521912df9254bb737}{Height\+Check}} (const \mbox{\hyperlink{a02017}{Node}} \&\mbox{\hyperlink{a02017}{Node}}, float height, \mbox{\hyperlink{a01357}{Embree\+Ray\+Tracer}} \&ert)
...
vector$<$ int $>$ \mbox{\hyperlink{a00401_a5cddfd8eb7ae23f8ecea0277ad5c3cc5}{Height\+Check\+All\+Nodes}} (const vector$<$ \mbox{\hyperlink{a02017}{Node}} $>$ \&nodes\+\_\+to\+\_\+filter, float height, \mbox{\hyperlink{a01357}{Embree\+Ray\+Tracer}} \&ert)
\begin{DoxyCompactList}\small\item\em Obtain the indexes of all nodes that pass the Height\+Check. \end{DoxyCompactList}\item 
bool \mbox{\hyperlink{a00401_a4d9cf77879eb78075f7f7b0a7e31119a}{Is\+Occlusion\+Between}} (const \mbox{\hyperlink{a02017}{Node}} \&node\+\_\+a, const \mbox{\hyperlink{a02017}{Node}} \&node\+\_\+b, \mbox{\hyperlink{a01357}{Embree\+Ray\+Tracer}} \&ert, float height=1.\+7f, float pre\+\_\+calculated\+\_\+distance=0.\+0f)
\begin{DoxyCompactList}\small\item\em Perform a line of sight check between two nodes. \end{DoxyCompactList}\item 
\mbox{\hyperlink{a01497}{Graph}} \mbox{\hyperlink{a00401_a12eb1e4c06400c4625cd22d925927b03}{All\+To\+All}} (\mbox{\hyperlink{a01357}{H\+F\+::\+Ray\+Tracer\+::\+Embree\+Ray\+Tracer}} \&ert, const std\+::vector$<$ \mbox{\hyperlink{a02017}{H\+F\+::\+Spatial\+Structures\+::\+Node}} $>$ \&input\+\_\+nodes, float height=1.\+7f)
...
\mbox{\hyperlink{a01497}{Graph}} \mbox{\hyperlink{a00401_ab1db87927118f70786a664c3b3cc7905}{All\+To\+All\+Undirected}} (\mbox{\hyperlink{a01357}{H\+F\+::\+Ray\+Tracer\+::\+Embree\+Ray\+Tracer}} \&ert, const std\+::vector$<$ \mbox{\hyperlink{a02017}{H\+F\+::\+Spatial\+Structures\+::\+Node}} $>$ \&nodes, float height, int cores=-\/1)
...
\mbox{\hyperlink{a01497}{H\+F\+::\+Spatial\+Structures\+::\+Graph}} for more info on the Graph Datatype that is returned from all functions in the \mbox{\hyperlink{a00401}{Visibility\+Graph}} namespace. 
\end{DoxySeeAlso}
...
{\footnotesize\ttfamily \mbox{\hyperlink{a01497}{H\+F\+::\+Spatial\+Structures\+::\+Graph}} H\+F\+::\+Visibility\+Graph\+::\+All\+To\+All (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{a01357}{H\+F\+::\+Ray\+Tracer\+::\+Embree\+Ray\+Tracer}} \&}]{ert,  }\item[{const std\+::vector$<$ \mbox{\hyperlink{a02017}{H\+F\+::\+Spatial\+Structures\+::\+Node}} $>$ \&}]{input\+\_\+nodes,  }\item[{float}]{height = {\ttfamily 1.7f} }\end{DoxyParamCaption})}
...
\DoxyCodeLine{std::string \mbox{\hyperlink{a00335_ad2d18c3c0371ab0b0822553fbbe333f9}{plane\_path}} = \textcolor{stringliteral}{"plane.obj"};}
\DoxyCodeLine{}
...
\DoxyCodeLine{std::vector<HF::Geometry::MeshInfo> meshInfo = \mbox{\hyperlink{a00403_a06c0c11adb62f8b204e42f75ac1990ac}{HF::Geometry::LoadMeshObjects}}(\mbox{\hyperlink{a00335_ad2d18c3c0371ab0b0822553fbbe333f9}{plane\_path}});}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{comment}{// Create an EmbreeRayTracer.}}
\DoxyCodeLine{\mbox{\hyperlink{a01357}{HF::RayTracer::EmbreeRayTracer}} tracer(meshInfo);}
\DoxyCodeLine{}
...
\DoxyCodeLine{\mbox{\hyperlink{a01497}{HF::SpatialStructures::Graph}} graph = \mbox{\hyperlink{a00401_a12eb1e4c06400c4625cd22d925927b03}{AllToAll}}(tracer, node\_vec, desired\_height);}
\end{DoxyCode}
...
Referenced by Create\+Visibility\+Graph\+All\+To\+All(), and T\+E\+S\+T().
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{a00401_a12eb1e4c06400c4625cd22d925927b03_icgraph}
\end{center}
\end{figure}
...
{\footnotesize\ttfamily \mbox{\hyperlink{a01497}{H\+F\+::\+Spatial\+Structures\+::\+Graph}} H\+F\+::\+Visibility\+Graph\+::\+All\+To\+All\+Undirected (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{a01357}{H\+F\+::\+Ray\+Tracer\+::\+Embree\+Ray\+Tracer}} \&}]{ert,  }\item[{const std\+::vector$<$ \mbox{\hyperlink{a02017}{H\+F\+::\+Spatial\+Structures\+::\+Node}} $>$ \&}]{nodes,  }\item[{float}]{height,  }\item[{int}]{cores = {\ttfamily -\/1} }\end{DoxyParamCaption})}
...
\DoxyCodeLine{    \textcolor{keywordflow}{for} (\textcolor{keywordtype}{float} j = -\/5; j < 5.0; j++) \{}
\DoxyCodeLine{        \textcolor{comment}{// runs 10 times}}
\DoxyCodeLine{        node\_vec.emplace\_back(\mbox{\hyperlink{a02017}{HF::SpatialStructures::Node}}(i, j, 0.0f)); \textcolor{comment}{// all Node ID default to -\/1}}
\DoxyCodeLine{    \}}
\DoxyCodeLine{\}}
\DoxyCodeLine{}
...
\DoxyCodeLine{\mbox{\hyperlink{a01497}{HF::SpatialStructures::Graph}} graph =}
...
Referenced by Create\+Visibility\+Graph\+All\+To\+All\+Undirected(), and T\+E\+S\+T().
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{a00401_ab1db87927118f70786a664c3b3cc7905_icgraph}
\end{center}
\end{figure}
...
{\footnotesize\ttfamily \mbox{\hyperlink{a01497}{H\+F\+::\+Spatial\+Structures\+::\+Graph}} H\+F\+::\+Visibility\+Graph\+::\+Group\+To\+Group (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{a01357}{H\+F\+::\+Ray\+Tracer\+::\+Embree\+Ray\+Tracer}} \&}]{ert,  }\item[{const std\+::vector$<$ \mbox{\hyperlink{a02017}{H\+F\+::\+Spatial\+Structures\+::\+Node}} $>$ \&}]{from,  }\item[{const std\+::vector$<$ \mbox{\hyperlink{a02017}{H\+F\+::\+Spatial\+Structures\+::\+Node}} $>$ \&}]{to,  }\item[{float}]{height = {\ttfamily 1.7f} }\end{DoxyParamCaption})}
...
\DoxyCodeLine{        \textcolor{comment}{// runs 10 times}}
\DoxyCodeLine{        node\_vec\_0.emplace\_back(\mbox{\hyperlink{a02017}{HF::SpatialStructures::Node}}(i, j, 0.0f));   \textcolor{comment}{// all Node ID default to -\/1}}
\DoxyCodeLine{    \}}
\DoxyCodeLine{\}}
\DoxyCodeLine{}
...
\DoxyCodeLine{        node\_vec\_1.emplace\_back(\mbox{\hyperlink{a02017}{HF::SpatialStructures::Node}}(i, j, 0.0f));   \textcolor{comment}{// all Node ID default to -\/1}}
\DoxyCodeLine{    \}}
\DoxyCodeLine{\}}
\DoxyCodeLine{}
...
\DoxyCodeLine{\textcolor{keywordtype}{float} desired\_height = 2.0f;        \textcolor{comment}{// Height of graph}}
\DoxyCodeLine{\mbox{\hyperlink{a01497}{HF::SpatialStructures::Graph}} graph = \mbox{\hyperlink{a00401_ae42a5aafdfcc29b6a668355c07602efb}{HF::VisibilityGraph::GroupToGroup}}(tracer, node\_vec\_0, node\_vec\_1, desired\_height);}
\end{DoxyCode}
...
Referenced by Create\+Visibility\+Graph\+Group\+To\+Group(), and T\+E\+S\+T().
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{a00401_ae42a5aafdfcc29b6a668355c07602efb_icgraph}
\end{center}
\end{figure}
...
{\footnotesize\ttfamily bool H\+F\+::\+Visibility\+Graph\+::\+Height\+Check (\begin{DoxyParamCaption}\item[{const \mbox{\hyperlink{a02017}{Node}} \&}]{Node,  }\item[{float}]{height,  }\item[{\mbox{\hyperlink{a01357}{Embree\+Ray\+Tracer}} \&}]{ert }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}
...
References H\+F\+::\+Ray\+Tracer\+::\+Embree\+Ray\+Tracer\+::\+Occluded(), and H\+F\+::\+Spatial\+Structures\+::\+R\+O\+U\+N\+D\+I\+N\+G\+\_\+\+P\+R\+E\+C\+I\+S\+I\+ON.
...
\end{center}
\end{figure}
\mbox{\Hypertarget{a00401_a5cddfd8eb7ae23f8ecea0277ad5c3cc5}\label{a00401_a5cddfd8eb7ae23f8ecea0277ad5c3cc5}} 
...
{\footnotesize\ttfamily vector$<$int$>$ H\+F\+::\+Visibility\+Graph\+::\+Height\+Check\+All\+Nodes (\begin{DoxyParamCaption}\item[{const vector$<$ \mbox{\hyperlink{a02017}{Node}} $>$ \&}]{nodes\+\_\+to\+\_\+filter,  }\item[{float}]{height,  }\item[{\mbox{\hyperlink{a01357}{Embree\+Ray\+Tracer}} \&}]{ert }\end{DoxyParamCaption})}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{a00401_a5cddfd8eb7ae23f8ecea0277ad5c3cc5_cgraph}
\end{center}
\end{figure}
Here is the caller graph for this function\+:
\nopagebreak
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{a00401_a5cddfd8eb7ae23f8ecea0277ad5c3cc5_icgraph}
\end{center}
\end{figure}
...
{\footnotesize\ttfamily bool H\+F\+::\+Visibility\+Graph\+::\+Is\+Occlusion\+Between (\begin{DoxyParamCaption}\item[{const \mbox{\hyperlink{a02017}{Node}} \&}]{node\+\_\+a,  }\item[{const \mbox{\hyperlink{a02017}{Node}} \&}]{node\+\_\+b,  }\item[{\mbox{\hyperlink{a01357}{Embree\+Ray\+Tracer}} \&}]{ert,  }\item[{float}]{height = {\ttfamily 1.7f},  }\item[{float}]{pre\+\_\+calculated\+\_\+distance = {\ttfamily 0.0f} }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}
...
References H\+F\+::\+Spatial\+Structures\+::\+Node\+::direction\+To(), H\+F\+::\+Spatial\+Structures\+::\+Node\+::distance\+To(), and H\+F\+::\+Ray\+Tracer\+::\+Embree\+Ray\+Tracer\+::\+Occluded().
