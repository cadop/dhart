...
{\footnotesize\ttfamily \mbox{\hyperlink{a00341_a91fa3b2bb3a7312ec39d74cc1fbc7bbe}{C\+\_\+\+INTERFACE}} Create\+Visibility\+Graph\+All\+To\+All (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{a01345}{HF\+::\+Ray\+Tracer\+::\+Embree\+Ray\+Tracer}} $\ast$}]{ert,  }\item[{const float $\ast$}]{nodes,  }\item[{int}]{num\+\_\+nodes,  }\item[{\mbox{\hyperlink{a01485}{HF\+::\+Spatial\+Structures\+::\+Graph}} $\ast$$\ast$}]{out\+\_\+graph,  }\item[{float}]{height }\end{DoxyParamCaption})}
...
\hline
{\em out\+\_\+graph} & Address of (\mbox{\hyperlink{a01485}{HF\+::\+Spatial\+Structures\+::\+Graph}} $\ast$); address of a pointer to a \mbox{\hyperlink{a01485}{HF\+::\+Spatial\+Structures\+::\+Graph}}. (out\+\_\+graph) will point to memory allocated by \mbox{\hyperlink{a00394_ga0255e6c4811298e61110adc64c0f8acd}{Create\+Visibility\+Graph\+All\+To\+All}}.\\
\hline
...
\DoxyCodeLine{        \mbox{\hyperlink{a01485}{HF::SpatialStructures::Graph}}* VG = \textcolor{keyword}{nullptr};}
\DoxyCodeLine{}
\DoxyCodeLine{        status = \mbox{\hyperlink{a00394_ga0255e6c4811298e61110adc64c0f8acd}{CreateVisibilityGraphAllToAll}}(bvh, points.data(), points\_count, \&VG, height);}
\DoxyCodeLine{}
...
\DoxyCodeLine{        status = \mbox{\hyperlink{a00392_gab7ecc1be5c746ed3f99ab7494316c65d}{Compress}}(VG);}
\DoxyCodeLine{}
\DoxyCodeLine{        \textcolor{keywordflow}{if} (status != 1) \{}
\DoxyCodeLine{            \textcolor{comment}{// Error!}}
...
\DoxyCodeLine{}
\DoxyCodeLine{        status = \mbox{\hyperlink{a00392_ga58e27a4c3b5a2d9692536877c2e13691}{GetCSRPointers}}(VG,}
\DoxyCodeLine{            \&csr.\mbox{\hyperlink{a01473_a67ae38cef6b322331f0e9100b3f480f8}{nnz}}, \&csr.\mbox{\hyperlink{a01473_ab7ef161d6dfc8b606c120cbf5181ed68}{rows}}, \&csr.\mbox{\hyperlink{a01473_a5aed9a3184fd7d7aded80c97c33e2dc5}{cols}},}
\DoxyCodeLine{            \&csr.\mbox{\hyperlink{a01473_ab31bc5e69630e9101a82790c3a525386}{data}}, \&csr.\mbox{\hyperlink{a01473_a9a946e3ae6172a03c6a98e1dee39cc19}{inner\_indices}}, \&csr.\mbox{\hyperlink{a01473_a49c0ac5c7fde9a797887699bc4670de4}{outer\_indices}},}
...
\DoxyCodeLine{        \textcolor{comment}{//}}
\DoxyCodeLine{        \textcolor{keywordtype}{float}* curr = csr.\mbox{\hyperlink{a01473_ab31bc5e69630e9101a82790c3a525386}{data}};                 \textcolor{comment}{// address of current position within edge data}}
\DoxyCodeLine{        \textcolor{keywordtype}{float}* data\_end = csr.\mbox{\hyperlink{a01473_ab31bc5e69630e9101a82790c3a525386}{data}} + csr.\mbox{\hyperlink{a01473_a67ae38cef6b322331f0e9100b3f480f8}{nnz}};    \textcolor{comment}{// address of one-\/past the last element within edge data}}
\DoxyCodeLine{}
\DoxyCodeLine{        \textcolor{keywordtype}{int}* inner = csr.\mbox{\hyperlink{a01473_a9a946e3ae6172a03c6a98e1dee39cc19}{inner\_indices}};            \textcolor{comment}{// address of current position within child node id buffer (column value)}}
...
\DoxyCodeLine{                (row == csr.\mbox{\hyperlink{a01473_ab7ef161d6dfc8b606c120cbf5181ed68}{rows}} -\/ 1)}
\DoxyCodeLine{                ? data\_end : csr.\mbox{\hyperlink{a01473_ab31bc5e69630e9101a82790c3a525386}{data}} + csr.\mbox{\hyperlink{a01473_a49c0ac5c7fde9a797887699bc4670de4}{outer\_indices}}[row + 1];}
\DoxyCodeLine{}
...
\DoxyCodeLine{        status = \mbox{\hyperlink{a00392_ga645abacd11e1fa535f953344aaa77727}{DestroyGraph}}(VG);}
\DoxyCodeLine{}
\DoxyCodeLine{        \textcolor{keywordflow}{if} (status != 1) \{}
...
Definition at line \mbox{\hyperlink{a00380_source_l00016}{16}} of file \mbox{\hyperlink{a00380_source}{visibility\+\_\+graph\+\_\+\+C.\+cpp}}.



References \mbox{\hyperlink{a00026_source_l00128}{HF\+::\+Visibility\+Graph\+::\+All\+To\+All()}}, \mbox{\hyperlink{a00179_source_l00024}{Convert\+Raw\+Float\+Array\+To\+Points()}}, and \mbox{\hyperlink{a00110_source_l00032}{HF\+::\+Exceptions\+::\+OK}}.
...
{\footnotesize\ttfamily \mbox{\hyperlink{a00341_a91fa3b2bb3a7312ec39d74cc1fbc7bbe}{C\+\_\+\+INTERFACE}} Create\+Visibility\+Graph\+All\+To\+All\+Undirected (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{a01345}{HF\+::\+Ray\+Tracer\+::\+Embree\+Ray\+Tracer}} $\ast$}]{ert,  }\item[{const float $\ast$}]{nodes,  }\item[{int}]{num\+\_\+nodes,  }\item[{\mbox{\hyperlink{a01485}{HF\+::\+Spatial\+Structures\+::\+Graph}} $\ast$$\ast$}]{out\+\_\+graph,  }\item[{float}]{height,  }\item[{const int}]{cores }\end{DoxyParamCaption})}
...
\DoxyCodeLine{        \mbox{\hyperlink{a01485}{HF::SpatialStructures::Graph}}* VG = \textcolor{keyword}{nullptr};}
\DoxyCodeLine{}
\DoxyCodeLine{        status = \mbox{\hyperlink{a00394_ga9b0664a60bcdf276b0fe0a2023b3d9b8}{CreateVisibilityGraphAllToAllUndirected}}(bvh, points.data(), points\_count, \&VG, height, core\_count);}
\DoxyCodeLine{}
\DoxyCodeLine{        \textcolor{keywordflow}{if} (status != 1) \{}
\DoxyCodeLine{            \textcolor{comment}{// Error!}}
...
Definition at line \mbox{\hyperlink{a00380_source_l00040}{40}} of file \mbox{\hyperlink{a00380_source}{visibility\+\_\+graph\+\_\+\+C.\+cpp}}.



References \mbox{\hyperlink{a00026_source_l00252}{HF\+::\+Visibility\+Graph\+::\+All\+To\+All\+Undirected()}}, \mbox{\hyperlink{a00179_source_l00024}{Convert\+Raw\+Float\+Array\+To\+Points()}}, and \mbox{\hyperlink{a00110_source_l00032}{HF\+::\+Exceptions\+::\+OK}}.
...
{\footnotesize\ttfamily \mbox{\hyperlink{a00341_a91fa3b2bb3a7312ec39d74cc1fbc7bbe}{C\+\_\+\+INTERFACE}} Create\+Visibility\+Graph\+Group\+To\+Group (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{a01345}{HF\+::\+Ray\+Tracer\+::\+Embree\+Ray\+Tracer}} $\ast$}]{ert,  }\item[{const float $\ast$}]{group\+\_\+a,  }\item[{const int}]{size\+\_\+a,  }\item[{const float $\ast$}]{group\+\_\+b,  }\item[{const int}]{size\+\_\+b,  }\item[{\mbox{\hyperlink{a01485}{HF\+::\+Spatial\+Structures\+::\+Graph}} $\ast$$\ast$}]{out\+\_\+graph,  }\item[{float}]{height }\end{DoxyParamCaption})}
...
\hline
{\em out\+\_\+graph} & Address of (\mbox{\hyperlink{a01485}{HF\+::\+Spatial\+Structures\+::\+Graph}} $\ast$); address of a pointer to a \mbox{\hyperlink{a01485}{HF\+::\+Spatial\+Structures\+::\+Graph}}. (out\+\_\+graph) will point to memory allocated by \mbox{\hyperlink{a00394_gaf2e404cb696aee3473cac0d1507576d8}{Create\+Visibility\+Graph\+Group\+To\+Group}}.\\
\hline
{\em height} & How far to offset nodes from the ground.\\
\hline
\end{DoxyParams}
...
\DoxyCodeLine{        \mbox{\hyperlink{a01485}{HF::SpatialStructures::Graph}}* VG = \textcolor{keyword}{nullptr};}
\DoxyCodeLine{}
\DoxyCodeLine{        status = \mbox{\hyperlink{a00394_gaf2e404cb696aee3473cac0d1507576d8}{CreateVisibilityGraphGroupToGroup}}(bvh, coords\_a.data(), count\_nodes\_a, coords\_b.data(), count\_nodes\_b, \&VG, height);}
\DoxyCodeLine{}
\DoxyCodeLine{        \textcolor{keywordflow}{if} (status != 1) \{}
\DoxyCodeLine{            \textcolor{comment}{// Error!}}
...
Definition at line \mbox{\hyperlink{a00380_source_l00064}{64}} of file \mbox{\hyperlink{a00380_source}{visibility\+\_\+graph\+\_\+\+C.\+cpp}}.



References \mbox{\hyperlink{a00179_source_l00024}{Convert\+Raw\+Float\+Array\+To\+Points()}}, \mbox{\hyperlink{a00026_source_l00189}{HF\+::\+Visibility\+Graph\+::\+Group\+To\+Group()}}, \mbox{\hyperlink{a00110_source_l00041}{HF\+::\+Exceptions\+::\+NO\+\_\+\+GRAPH}}, and \mbox{\hyperlink{a00110_source_l00032}{HF\+::\+Exceptions\+::\+OK}}.
