...
namespace HF::SpatialStructures
{
	struct PathMember {
		...
		/// \code{.cpp}
		/// PathMember p0 = { 3.14f, 3 };
		/// PathMember p1 = { 2.78f, 2 };
		/// PathMember p2 = { 2.78f, 2 };
		///
		/// bool equiv = p1 == p2;
		/// bool not_equiv = p0 == p1;
		///
	...
	public:
		...
		/// PathMember p0 = { 3.14f, 3 };
		/// PathMember p1 = { 2.78f, 2 };
		/// PathMember p2 = { 1.64f, 1 };
		/// PathMember p3 = { 9.35, 7 };
		///
		///	// Create the container of PathMembers
		/// std::vector<PathMember> members{p0, p1, p2, p3};
		///
		...
		/// \code{.cpp}
		/// // Assuming an instance of Path, named path, already exists --
		/// // we can use AddNode to construct a PathMember and have Path add it to its members container.
		///
		/// int node_id = 278;
		/// float cost = 3.14f;
		///
		...
		/// PathMember p1 = { 2.78f, 2 };
		/// PathMember p2 = { 1.64f, 1 };
		/// PathMember p3 = { 9.35f, 7 };
		///
		///	// Create the container of PathMembers
		/// std::vector<PathMember> members{p0, p1, p2, p3};
		///
		/// Path path(members);			// Create the Path object, path
		...
		/// \code{.cpp}
		/// PathMember p0 = { 3.14f, 3 };				// Create all the PathMember objects
		/// PathMember p1 = { 2.78f, 2 };
		///
		/// PathMember p2 = { 3.14f, 3 };
		/// PathMember p3 = { 2.78f, 2 };
		///
		/// PathMember p4 = { 1.1f, 9 };
		/// PathMember p5 = { 123.0f, 10 };
		///
		/// std::vector<PathMember> members_0{p0, p1};	// Create the PathMember vectors
		/// std::vector<PathMember> members_1{p2, p3};
		/// std::vector<PathMember> members_2{p4, p5};
		/// std::vector<PathMember> members_3{p1, p0};

		///	Path path_0(members_0);						// Create the Path objects
		/// Path path_1(members_1);
		/// Path path_2(members_2);
		/// Path path_3(members_3);
		///
		...
		/// PathMember result = path[desired_index];	// a copy of the element at desired_index
