...
\DoxyCodeLine{\Hypertarget{a00122_source_l00039}00039         \textcolor{keywordtype}{bool} ret = tinyobj::LoadObj(\&attrib, \&shapes, \&materials, \&warn, \&err, filename);}
...
\DoxyCodeLine{\Hypertarget{a00122_source_l00084}00084                     tinyobj::real\_t vx = attrib.vertices[3 * idx.vertex\_index + 0];}
\DoxyCodeLine{\Hypertarget{a00122_source_l00085}00085                     tinyobj::real\_t vy = attrib.vertices[3 * idx.vertex\_index + 1];}
\DoxyCodeLine{\Hypertarget{a00122_source_l00086}00086                     tinyobj::real\_t vz = attrib.vertices[3 * idx.vertex\_index + 2];}
...
\DoxyCodeLine{\Hypertarget{a00122_source_l00260}00260             MI.emplace\_back(\mbox{\hyperlink{a01285}{MeshInfo}}(vertexes, index\_array, 0, name));}
...
\DoxyCodeLine{\Hypertarget{a00122_source_l00296}00296                 MI[k] = \mbox{\hyperlink{a01285}{MeshInfo}}(current\_vertices, \textcolor{keywordtype}{id}, name);}
...
\DoxyCodeLine{\Hypertarget{a00122_source_l00351}00351                 MI.push\_back(\mbox{\hyperlink{a01285}{MeshInfo}}(mesh, i, names[i]));}
