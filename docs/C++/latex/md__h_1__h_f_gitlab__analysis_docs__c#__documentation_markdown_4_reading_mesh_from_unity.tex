Previous Tutorial\+: H\+:/\+H\+F\+Gitlab/\+Analysis/docs/C\# Documentation/markdown/3\+\_\+graph\+\_\+generator.\+md \char`\"{}\+The Graph Generator\char`\"{}


\begin{DoxyItemize}
\item \href{\#reading-a-mesh-from-unity}{\texttt{ Reading a Mesh From Unity}}
\begin{DoxyItemize}
...
\end{DoxyItemize}
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md__h_1__h_f_gitlab__analysis_docs__c#__documentation_markdown_4_reading_mesh_from_unity_autotoc_md27}{}\doxysection{Intro}\label{md__h_1__h_f_gitlab__analysis_docs__c#__documentation_markdown_4_reading_mesh_from_unity_autotoc_md27}
This tutorial will demonstrate how to pass geometry from the scene in Unity to Human Factors. We\textquotesingle{}ll be using the project created in the previous guide\+: H\+:/\+H\+F\+Gitlab/\+Analysis/docs/C\# Documentation/markdown/3\+\_\+graph\+\_\+generator.\+md \char`\"{}\+The Graph Generator\char`\"{}, and we\textquotesingle{}ll be using concepts covered in the previous guides.\hypertarget{md__h_1__h_f_gitlab__analysis_docs__c#__documentation_markdown_4_reading_mesh_from_unity_autotoc_md28}{}\doxysection{Scene Setup}\label{md__h_1__h_f_gitlab__analysis_docs__c#__documentation_markdown_4_reading_mesh_from_unity_autotoc_md28}
...
From here we will create a new plane then translate it directly to the origin.\hypertarget{md__h_1__h_f_gitlab__analysis_docs__c#__documentation_markdown_4_reading_mesh_from_unity_autotoc_md29}{}\doxysubsection{Creating the Plane}\label{md__h_1__h_f_gitlab__analysis_docs__c#__documentation_markdown_4_reading_mesh_from_unity_autotoc_md29}
Using the menubar at the top of the screen select Game\+Object $>$ 3D Object $>$ Plane.



Once clicked, a new 1x1 plane will be created, however it may not have been created at the origin exactly. For this tutorial we will reset the plane\textquotesingle{}s position just be be sure it\textquotesingle{}s always placed exactly in the same place.\hypertarget{md__h_1__h_f_gitlab__analysis_docs__c#__documentation_markdown_4_reading_mesh_from_unity_autotoc_md30}{}\doxysubsection{Resetting the Plane\textquotesingle{}s Position}\label{md__h_1__h_f_gitlab__analysis_docs__c#__documentation_markdown_4_reading_mesh_from_unity_autotoc_md30}
...
Now that we have the plane ready to go, we can begin working on the script to get its vertices and triangles.\hypertarget{md__h_1__h_f_gitlab__analysis_docs__c#__documentation_markdown_4_reading_mesh_from_unity_autotoc_md31}{}\doxysection{Writing the Script}\label{md__h_1__h_f_gitlab__analysis_docs__c#__documentation_markdown_4_reading_mesh_from_unity_autotoc_md31}
Open up the New Behavior script we created in the H\+:/\+H\+F\+Gitlab/\+Analysis/docs/C\# Documentation/markdown/3\+\_\+graph\+\_\+generator.\+md \char`\"{}previous tutorial\char`\"{}\hypertarget{md__h_1__h_f_gitlab__analysis_docs__c#__documentation_markdown_4_reading_mesh_from_unity_autotoc_md32}{}\doxysubsection{Set Usings}\label{md__h_1__h_f_gitlab__analysis_docs__c#__documentation_markdown_4_reading_mesh_from_unity_autotoc_md32}
...
\hypertarget{md__h_1__h_f_gitlab__analysis_docs__c#__documentation_markdown_4_reading_mesh_from_unity_autotoc_md33}{}\doxysubsection{Setup for adding references through the unity inspector}\label{md__h_1__h_f_gitlab__analysis_docs__c#__documentation_markdown_4_reading_mesh_from_unity_autotoc_md33}
...
Later we\textquotesingle{}ll use the unity inspector to assign the plane we created in the scene to this object\hypertarget{md__h_1__h_f_gitlab__analysis_docs__c#__documentation_markdown_4_reading_mesh_from_unity_autotoc_md34}{}\doxysubsection{Passing Meshes from Game\+Objects to Human\+Factors}\label{md__h_1__h_f_gitlab__analysis_docs__c#__documentation_markdown_4_reading_mesh_from_unity_autotoc_md34}
Now that we have a reference to the plane game object we want to use, we need to get the raw vertices and faces of plane so we can pass it to Human\+Factors for use in the graph generator.\hypertarget{md__h_1__h_f_gitlab__analysis_docs__c#__documentation_markdown_4_reading_mesh_from_unity_autotoc_md35}{}\doxysubsubsection{Getting a reference to the mesh held by a specific Game Object}\label{md__h_1__h_f_gitlab__analysis_docs__c#__documentation_markdown_4_reading_mesh_from_unity_autotoc_md35}
...
\end{DoxyCode}
\hypertarget{md__h_1__h_f_gitlab__analysis_docs__c#__documentation_markdown_4_reading_mesh_from_unity_autotoc_md36}{}\doxysubsubsection{Getting the vertices and triangles from a Unity Mesh}\label{md__h_1__h_f_gitlab__analysis_docs__c#__documentation_markdown_4_reading_mesh_from_unity_autotoc_md36}
...
\hypertarget{md__h_1__h_f_gitlab__analysis_docs__c#__documentation_markdown_4_reading_mesh_from_unity_autotoc_md37}{}\doxysubsubsection{Transforming the Mesh from Y-\/\+Up to Z-\/\+Up}\label{md__h_1__h_f_gitlab__analysis_docs__c#__documentation_markdown_4_reading_mesh_from_unity_autotoc_md37}
...
screenshot, so instead I\textquotesingle{}ll just post the full code in this document here.\hypertarget{md__h_1__h_f_gitlab__analysis_docs__c#__documentation_markdown_4_reading_mesh_from_unity_autotoc_md38}{}\doxysection{Executing the Script}\label{md__h_1__h_f_gitlab__analysis_docs__c#__documentation_markdown_4_reading_mesh_from_unity_autotoc_md38}
\hypertarget{md__h_1__h_f_gitlab__analysis_docs__c#__documentation_markdown_4_reading_mesh_from_unity_autotoc_md39}{}\doxysubsection{Adding References Through the Unity Inspector}\label{md__h_1__h_f_gitlab__analysis_docs__c#__documentation_markdown_4_reading_mesh_from_unity_autotoc_md39}
\hypertarget{md__h_1__h_f_gitlab__analysis_docs__c#__documentation_markdown_4_reading_mesh_from_unity_autotoc_md40}{}\doxysubsection{Comparing Output}\label{md__h_1__h_f_gitlab__analysis_docs__c#__documentation_markdown_4_reading_mesh_from_unity_autotoc_md40}
