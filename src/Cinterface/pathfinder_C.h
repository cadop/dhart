...
/*!
	\brief	 Create a path from start to end in C++, with a cost type. 
			 If no path exists, the NO_PATH error code will be
			 returned, and both pointers will be left as they were before the function was called.
	\brief
	...
	\param	end			An array of ids for ending nodes. 
						...
						nodes that already exist within the graph.
	\param	out_size	The (PathMember *) count, how many PathMember objects compose a Path
	\param	out_path	Pointer to a buffer of (Path *)
	\param	out_data	Pointer to a buffer of (PathMember *)
