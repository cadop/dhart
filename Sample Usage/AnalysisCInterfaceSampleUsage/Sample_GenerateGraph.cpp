/*!
	\file		Sample_GenerateGraph.cpp
	\brief		Driver source file for testing functionality of the graph generation functions
...
namespace CInterfaceTests {
	...
	*/
	...
	void generate_graph(HINSTANCE dll_hf);
}
...
int main(int argc, const char* argv[]) {
	...
	*/
	...
	if (dll_DHART_API == nullptr) {
		...
		///
		CInterfaceTests::generate_graph(dll_DHART_API);
...
*/
void CInterfaceTests::generate_graph(HINSTANCE dll_hf) {
	///
	...
	std::cout << node_vector_size << std::endl;
