			...
			*/
			...
			/*!
				\code
					...
					// i.e. indices[0] represents the 0th set of (x, y, z) coordinates, {34.1, 63.9, 16.5}
					//		indices[1] represents the 1st set of (x, y, z) coordinates, {23.5, 85.7, 45.2}
					//		indices[2] represents the 2nd set of (x, y, z) coordinates, {12.0, 24.6, 99.4}
			...
			*/
			...
			/*!
				\code
					...
					// If indices_0.size() == 3, this means that vertices_0.size() == 9,
					// and each member of indices represents a std::array<float, 3>
					// i.e. indices[0] represents the 0th set of (x, y, z) coordinates, {34.1, 63.9, 16.5}
					//		indices[1] represents the 1st set of (x, y, z) coordinates, {23.5, 85.7, 45.2}
					//		indices[2] represents the 2nd set of (x, y, z) coordinates, {12.0, 24.6, 99.4}
